...
public class BaseIntTests
{
    ...
    public void Constructor_For1_Len0_Base10_ReturnsCorrectProperties() 
        => Assert.ThrowsException<ArgumentOutOfRangeException>(() => new BaseInt(10, 1, 0));
    ...
    {
        BaseInt actual = new BaseInt(10, 12345, 5).Reverse();
        Assert.AreEqual(5, actual.Length);
    ...
    {
        BaseInt actual = new BaseInt(10, 12340, 5).Reverse();
        Assert.AreEqual(5, actual.Length);
